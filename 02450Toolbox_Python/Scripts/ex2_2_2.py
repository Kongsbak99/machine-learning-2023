...
# ex 2.2.2
# prove that it takes 22 components to explain 90% of the variance
# i.e. prove that the sum of the first 22 values is 0.9
var90 = sum(rho[0:22])
...
figure(figsize=(8,6))
for k in range(K):
    N1 = int(np.ceil(np.sqrt(K))); N2 = int(np.ceil(K/N1))
